...
<body onload="onLoad()">
			...
			<div class="wrapperIn2">
				...
				<div class="sidebarright">
					...
					<div class="ordercake">
								...
								<div class="fullform">
									...
									<div class="cackrighttexbox">
										<input class="texboxitemcode" id="sp_code"
											...
											required autocomplete="off" list="categories"
											onblur="onBlurSpCode(this.value)">
						...
						<!----------------------------------------Form Start-------------------------------------------------->
						<form action="${pageContext.request.contextPath}/orderSpCake"
							...
							<div class="center">
								...
								<div class="colOuter">
									...
									<div class="col2full">
										<input class="texboxitemcode texboxcal2" autocomplete="off"
 ...
 --%>
								...
								<div class="colOuter">
									...
									<div class="col2full">
										<input id="datepicker4" class="texboxitemcode texboxcal"
											placeholder="<%=fDate%>" name="datepicker4" type="text"
											required>
									</div>
								</div>
								<div class="colOuter">
								...
								<div class="colOuter">
									<div class="col1">
										<input class="texboxitemcode texboxcal2"
											placeholder="Booked For" name="sp_booked_for_name" value="1"
							...
							<div class="right">
								<div class="priceBox">
									<h2 class="inrbox" id="INR" style="font-size: 25px;">INR -
										${(sprRate*specialCake.spMinwt)}</h2>
							...
							<c:if test="${specialCake.spTax1!=0 or specialCake.spTax1!=0.00}">
								<input type="hidden" id="t1amt" name="t1amt"
									value="${(sprRate*specialCake.spMinwt)*(specialCake.spTax1)/100}">
							...
							<c:if test="${specialCake.spTax2!=0 or specialCake.spTax2!=0.00}">
								<input type="hidden" id="t2amt" name="t2amt"
									value="${(sprRate*specialCake.spMinwt)*(specialCake.spTax2)/100}">

							</c:if>

							<input type="hidden" id="dbAdonRate" name="dbAdonRate"> <input
