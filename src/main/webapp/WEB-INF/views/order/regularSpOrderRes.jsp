				...
				<div class="ordercake">
					...
					<div class="left">
						...
						<div class="fullform">
							...
							<div class="cackrighttexbox">Regular</div>
						</div>
						...
						<div class="fullform">
							...
							<div class="cackright" id="sp_name">
								<span class="cakename" id="rg_ck_name"> ${spName}</span>
							</div>
						</div>
						&nbsp; &nbsp; &nbsp;
...
<div class="colOuter">
						...
						<div class="colOuter">
							...
							<div class="col2full">
								<div class="col1title">${rspDeliveryDt}</div>
							</div>
						</div>
						<div class="colOuter"></div>
						...
						<div class="colOuter">
							...
							<div class="col2full">
								<div class="col1title">${spPlace}</div>
							</div>
						</div>
						...
						<div class="colOuter">
							...
							<div class="col2full">
								<div class="col1title">${spCustDOB}</div>
							</div>
						</div>
						...
						<div class="colOuter">
							...
							<div class="col2full">
								<div class="col1title">${rspCustMobileNo}</div>
							</div>
						</div>
						...
						<div class="colOuter">
							...
							<div class="col2">
								<input id="datepicker5" class="texboxitemcode texboxcal"
									placeholder="" name="datepicker5" type="hidden">
							</div>
							<div class="col3">
								<input class="texboxitemcode" placeholder="Mobile No."
									name="sp_book_for_number" type="hidden" id="sp_book_for_number">
							</div>
						</div>
					...
					<div class="right">
						<div class="priceBox">
							<h2 class="inrbox" id="INR">
								INR -
								<fmt:formatNumber minFractionDigits="2" maxFractionDigits="2"
									type="number" value="${rgCkPrice}" groupingUsed="false" />
							</h2>
								...
								<ul>
									...
									<li>
										...
										<div class="priceRight" id="subtotal">
											<fmt:formatNumber minFractionDigits="2" maxFractionDigits="2"
												type="number" value="${rspSubTotal}" groupingUsed="false" />
										</div>
									</li>
									<li>
										<div class="priceLeft">GST</div>
										<div class="priceRight" id="tax3">
											<fmt:formatNumber minFractionDigits="2" maxFractionDigits="2"
												type="number" value="${tax}" groupingUsed="false" />
											%
										</div>
									</li>
									<li>
										...
										<div class="priceRight" id="gstrs">
											<fmt:formatNumber minFractionDigits="2" maxFractionDigits="2"
												type="number" value="${gstRs}" groupingUsed="false" />
										</div>
									</li>
									<li class="total">
										<div class="priceLeft" id="mgstamt">
											AMT-
											<fmt:formatNumber minFractionDigits="2" maxFractionDigits="2"
												type="number" value="${rgGstAmount}" groupingUsed="false" />
										</div>
										...
										<div class="priceRight" id="tot">
											TOTAL-
											<fmt:formatNumber minFractionDigits="2" maxFractionDigits="2"
												type="number" value="${totalAmt}" groupingUsed="false" />
										</div>
									...
									<li class="advance">
										...
										<div class="priceRight">
											<fmt:formatNumber minFractionDigits="2" maxFractionDigits="2"
												type="number" value="${rspAdvanceAmt}" groupingUsed="false" />
										</div>
							...
							<div class="remainamount">
								...
								<div class="priceRight" id="rmAmt">
									<fmt:formatNumber minFractionDigits="2" maxFractionDigits="2"
										type="number" value="${rspRemainingAmt}" groupingUsed="false" />
								</div>
		...
		<div>
			<a
				href="${pageContext.request.contextPath}/showRegularSpCakeOrder/${globalIndex}"><input
				type="button" class="btn btn-primary" value="Back"> <!-- <h1>
					<< Back</h1> --></a> <a
				href="${pageContext.request.contextPath}/showRegCakeOrderPDF"
				target="_blank"><input type="button" class="btn btn-primary"
				value="PDF"> <!-- <h1>PDF</h1> --></a>
		</div>
	</div>
