						...
						<div class="priceBox">
							<h2 class="inrbox" style="font-size: 20px;">
								INR - <span id="pro_grand_totla_1" style="font-size: 20px;">
									<fmt:formatNumber minFractionDigits="2" maxFractionDigits="2"
										type="number" value="${specialCake.spGrandTotal}"
										groupingUsed="false" />
								</span>
							</h2>
							...
							<div class="inrboxmiddle">
								<ul>
									...
									<li>
										...
										<div class="priceRight" id="pro_price">
											<fmt:formatNumber minFractionDigits="2" maxFractionDigits="2"
												type="number" value="${specialCake.spPrice}"
												groupingUsed="false" />
										</div>
									</li>
									<li>
										<div class="priceLeft">Add Rate</div>
										<div class="priceRight" id="pro_adon_price">
											<fmt:formatNumber minFractionDigits="2" maxFractionDigits="2"
												type="number" value="${specialCake.spTotalAddRate}"
												groupingUsed="false" />
										</div>
									...
									<li>
										...
										<div class="priceRight" id="ex_charges">
											<fmt:formatNumber minFractionDigits="2" maxFractionDigits="2"
												type="number" value="${exCharges}" groupingUsed="false" />
										</div>

									</li>
									<li>
										<div class="priceLeft">Discount(%)</div>
										<div class="priceRight" id="ex_disc">
											<fmt:formatNumber minFractionDigits="2" maxFractionDigits="2"
												type="number" value="${disc}" groupingUsed="false" />
										</div>

									</li>
									<li>
										<div class="priceLeft">Sub Total</div>
										<div class="priceRight" id="pro_total_price">
											<fmt:formatNumber minFractionDigits="2" maxFractionDigits="2"
												type="number" value="${specialCake.spSubTotal}"
												groupingUsed="false" />
										</div>
									...
									<li class="advance">
										...
										<div class="priceRight">
											<fmt:formatNumber minFractionDigits="2" maxFractionDigits="2"
												type="number" value="${specialCake.spAdvance}"
												groupingUsed="false" />
										</div>
									</li>
								</ul>
							...
							<div class="remainamount">
								...
								<div class="priceRight" id="rem_amount">
									<fmt:formatNumber minFractionDigits="2" maxFractionDigits="2"
										type="number" value="${specialCake.rmAmount}"
										groupingUsed="false" />
								</div>
							</div>
...
<div class="messages messagesSuccess">success message </div>-->
			...
			<a
				href="${pageContext.request.contextPath}/showSpCakeOrder/${globalIndex}"><input
				type="button" class="btn btn-primary" value="Back"> </a> <a
				href="${pageContext.request.contextPath}/showSpCakeOrderHisPDF/${specialCake.spOrderNo}"
