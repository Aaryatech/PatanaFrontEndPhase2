			...
			<div class="wrapperIn2">
				...
				<div class="title_row_one marg_top_btm">
					<div class="left_title">
						<h2 class="pageTitle"><i class="fa fa-file-o"></i> View HSN Code wise Report</h2>
					</div>
							...
							function(data) {
								...
								$.each(data,function(key, list) {
									...
									var tr = $('<tr></tr>');
								  	...
								  	tr.append($('<td style="text-align:right"></td>').html(list.hsnNo));

								  	tr.append($('<td style="text-align:right"></td>').html(list.cgst.toFixed(2)));
								  	cgstTotal=cgstTotal + list.cgst;
								  	
								  	tr.append($('<td style="text-align:right"></td>').html(list.sgst.toFixed(2)));
								  	sgstTotal=sgstTotal + list.sgst;
								  	
								   	tr.append($('<td style="text-align:right"></td>').html(list.igst.toFixed(2)));
									...
									taxTotal=taxTotal + list.totalTax;
								  	...
								  	tr.append($('<td style="text-align:right"></td>').html(list.grandTotal.toFixed(2)));
