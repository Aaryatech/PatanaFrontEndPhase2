			...
			maxFractionDigits="2" minFractionDigits="2" value=" ${billList.qty*billList.mrp}"/></span></td>
											...
											<tr>
												<td colspan="3" align="right"><span class="style5"><strong>Discount
															<fmt:formatNumber type="number" maxFractionDigits="2" minFractionDigits="2" value="${billList[0].discountPer}"/>% :</strong></span></td>
											...
											<tr>
												<td colspan="3" align="right"><span class="style7">Bill
														Total:</span></td>
												<td align="right"><span class="style7"><c:choose><c:when test="${billType eq 'R'}"><fmt:formatNumber type="number" maxFractionDigits="2" minFractionDigits="2" value="${billList[0].discountAmt-billList[0].intDiscAmt}"/></c:when><c:otherwise><fmt:formatNumber type="number" maxFractionDigits="2" minFractionDigits="2" value="${billList[0].intBillAmt}"/></c:otherwise> </c:choose></span></td>
											</tr>
										</tbody>
									</table></td>
							</tr>
