				...
				<div class="colOuter">
				 <div class="title_row_one">
					<div class="left_title">
						<h2 class="pageTitle"><i class="fa fa-file-pdf-o"></i> Stock Exchange To Franchisee </h2>
					</div>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <span class="close">&times;</span>
							...
							<input  name="UPDATE" class="buttonsaveorder" type="submit" value="UPDATE" >
						</div>
					</form>
						<div class="clr"></div>		
													...
													function(key, detail) {
														...
														tr
																.append($(
																		'<td></td>')
																		.html(
																				'&nbsp; <input type="Number" onchange="calculateCost('+detail.transferDetailId+')"   id="uQty'+detail.transferDetailId+'" name="uQty'+detail.transferDetailId+'" value="'+
																				detail.qty+'" >'));
														
														tr
														.append($(
																'<td id="mRp'+detail.transferDetailId+'"  style="text-align:right;"></td>')
																.html(
																		detail.itemMrp));
														tr
																.append($(
																		'<td id="rateTot'+detail.transferDetailId+'"  style="text-align:right;"></td>')
																		.html(
																				detail.grandTotal));
...
function calculateCost(val) {
	var mrp=document.getElementById("mRp"+val).innerHTML;
	var qty=document.getElementById("uQty"+val).value;
	var rateTotal=mrp*qty;
	document.getElementById("rateTot"+val).innerHTML=rateTotal;
	//alert(mrp+rate+qty);
	...
	<script type="text/javascript">
		function searchSellBill() {
			...
			if (isValid) {
				...
				var fromDate = document.getElementById("fromdatepicker").;
