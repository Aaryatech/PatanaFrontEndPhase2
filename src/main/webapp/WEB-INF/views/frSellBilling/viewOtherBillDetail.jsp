					...
					<form name="frm_search" id="frm_search" method="post"
						...
						<div class="col-md -3">
							...
							<div class="col1title" align="left">
								<h3>Other Purchase Bill Detail</h3>
							</div>
						</div>
						...
						<div class="colOuter">
							...
							<div class="col-md-1" align="left">${supplier.suppName}</div>
							<div class="col-md-1"></div>
						...
						<div class="colOuter">
							...
							<div class="col-md-1" align="left">
								<fmt:formatNumber type="number" minFractionDigits="2"
									groupingUsed="false" maxFractionDigits="2"
									value="${otherBillHeader.taxableAmt}" />
							</div>
							<div class="col-md-1"></div>
						...
						<div class="colOuter">
							...
							<div class="col-md-1" align="left">
								<fmt:formatNumber type="number" minFractionDigits="2"
									groupingUsed="false" maxFractionDigits="2"
									value="${otherBillHeader.grandTotal}" />
							</div>
							...
							<div id="faux-table" class="faux-table" aria="hidden">
								<table id="table_grid" class="main-table" border="1">
									...
									<tr class="bgpink">
										...
										<th class="col-md-1" style="text-align: center;">Base
											Rate</th>
										<th class="col-md-1" style="text-align: center;">Discount
											Amt</th>
							...
							<div class="table-wrap">
								<table id="table_grid" class="main-table" border="1">
									...
									<tbody>
										...
										<c:forEach items="${otherBillHeader.otherBillDetailList}"
											var="otherBillDetailList" varStatus="count">
											<tr>
												<td width="5%"><c:out value="${count.index+1}" /></td>
												<td class="col-md-3"><c:set var="name" value="" /> <c:forEach
														items="${itemsList}" var="itemsList">
														<c:choose>
															<c:when
																test="${otherBillDetailList.itemId==itemsList.id}">
																<c:set var="name" value="${itemsList.itemName}" />
															</c:when>
														</c:choose>
