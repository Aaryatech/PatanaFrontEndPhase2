		...
		<div class="wrapperIn2">
			...
			<div class="sidebarright">
				...
				<form name="frm_search" id="frm_search" method="post"
					action="${pageContext.request.contextPath}/getPurchaseBillPdf">
									...
									<tr>
										...
										<td class="col-md-1" style="text-align: center;"><div>
												<a
													...
													<a
													href="${pageContext.request.contextPath}/pdf/purchaseBillMatrixPdf/By-Road/0/${billHeader.billNo}"
													class="fa fa-file-pdf-o" target="_blank" title="PDF"></a>
...
$('.bill-class').each(function (i) {
	...
	function printSelctBills() {
		...
		window
		.open('${pageContext.request.contextPath}/pdf/purchaseBillMatrixPdf/By-Road/0/'
				+ billIds.join());
