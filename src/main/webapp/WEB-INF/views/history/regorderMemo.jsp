	...
	<table width="250" border="0" cellspacing="0" cellpadding="0"
      ...
      <td colspan="2" align="center" style="padding:5px; border-bottom:1px solid #E7E7E7;"><img src="${pageContext.request.contextPath}/resources/images/monginislogo.png" alt="logo"></td>
					...
					<table width="250" border="0" cellspacing="0" cellpadding="0"
						...
						<tbody>
							...
							<tr>
								...
								<td>${regularSpCake.orderDate}</td>
								<td><strong></td>
							</tr>
							<tr>
								<td><strong>Time:</strong></td>
								<td>${regularSpCake.orderTime}</td>
								<td><strong></td>
							</tr>
							<tr>
											...
											<tr>
												...
												<td align="center"><p style="font-size: 12px">
														<fmt:formatNumber minFractionDigits="2"
															...
															value="${regularSpCake.rate}" groupingUsed="false" />
													</p></td>
												<td align="right"><p style="font-size: 12px">
														<fmt:formatNumber minFractionDigits="2"
															maxFractionDigits="2" type="number"
															value="${regularSpCake.rspSubTotal}" groupingUsed="false" />
													</p></td>
											</tr>
             ...
             -->
											...
											<tr>
												...
												<td align="right"><strong><fmt:formatNumber
															...
															value="${regularSpCake.rspSubTotal}" groupingUsed="false" /></strong></td>
											</tr>
											<tr>
												...
												<td align="right"><strong><fmt:formatNumber
															minFractionDigits="2" maxFractionDigits="2" type="number"
															value="${regularSpCake.rspAdvanceAmt}"
															groupingUsed="false" /></strong></td>
											</tr>
											<tr>
												<td colspan="2" align="right"><strong>Balance:</strong></td>
												<td align="right"><strong><fmt:formatNumber
															minFractionDigits="2" maxFractionDigits="2" type="number"
															value="${regularSpCake.rspRemainingAmt}"
															groupingUsed="false" /></strong></td>
											</tr>
										</tbody>
									</table></td>
			...
			<tr>
				<td width="200"
					style="border-top: 1px solid #E7E7E7; padding: 5px 7px;"><strong>Customer
						Phno : </strong> ${regularSpCake.rspCustMobileNo}</td>
			</tr>
			<tr>
				<td colspan="2"
