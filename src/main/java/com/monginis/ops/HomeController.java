...
public class HomeController {
	...
	public String displayLoginAgain(HttpServletRequest request, HttpServletResponse response,Model model) {

		 
		logger.info("/login request mapping.");

		//model.addAttribute("message", "Session timeout ! Please login again . . .");
